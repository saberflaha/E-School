...
WebUI.waitForElementClickable(findTestObject('material file/Page_-   -  -   - joacademy.com/add fovaret file'), 10)
WebUI.click(findTestObject('material file/Page_-   -  -   - joacademy.com/add fovaret file'))
boolean fovaret = WebUI.verifyElementPresent(findTestObject('Object Repository/downloade file/Page_-   -  -   - joacademy.com/verify add favorite file'),
